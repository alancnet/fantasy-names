...
module.exports = generatorOf(function generator$miscellaneous$foods() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 6) {
			...
			rnd = Math.floor(this.random() * names6.length);
			rnd2 = Math.floor(this.random() * names7.length);
			if (i < 8) {
				rnd3 = Math.floor(this.random() * names6.length);
				while (rnd3 === rnd) {
					rnd3 = Math.floor(this.random() * names6.length);
				}
