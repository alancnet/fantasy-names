...
module.exports = generatorOf(function generator$miscellaneous$afterlifes(type) {
	var nm1 = ["a", "e", "i", "o", "u", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""];
	...
	i = Math.floor(this.random() * 10); {
		if (type != 1) {
			if (i < 5) {
				rnd0 = Math.floor(this.random() * nm1.length);
				rnd1 = Math.floor(this.random() * nm2.length);
			...
			if (i < 5) {
				rnd0 = Math.floor(this.random() * nm8.length);
				rnd1 = Math.floor(this.random() * nm9.length);
