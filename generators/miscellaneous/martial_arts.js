...
module.exports = generatorOf(function generator$miscellaneous$martial_arts() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 2) {
			...
			rnd2 = Math.floor(this.random() * nm5.length);
			rnd3 = Math.floor(this.random() * nm6.length);
			rnd4 = Math.floor(this.random() * nm5.length);
			rnd5 = Math.floor(this.random() * nm9.length);
			rnd6 = Math.floor(this.random() * nm4.length);
			rnd7 = Math.floor(this.random() * nm5.length);
			...
			rnd6 = Math.floor(this.random() * nm11.length);
			rnd7 = Math.floor(this.random() * nm15.length);
			names = nm10[rnd] + nm11[rnd2] + nm12[rnd3] + nm13[rnd4] + nm14[rnd5] + nm11[rnd6] + nm15[rnd7];
		} else if (i < 7) {
			rnd = Math.floor(this.random() * nm16.length);
			rnd2 = Math.floor(this.random() * nm17.length);
			rnd3 = Math.floor(this.random() * nm18.length);
			rnd4 = Math.floor(this.random() * nm17.length);
			rnd5 = Math.floor(this.random() * nm19.length);
			...
			rnd7 = Math.floor(this.random() * nm19.length);
			names = nm16[rnd] + nm17[rnd2] + nm18[rnd3] + nm17[rnd4] + nm18[rnd5] + nm17[rnd6] + nm19[rnd7];
		} else if (i === 8) {
			rnd = Math.floor(this.random() * nm16.length);
			rnd2 = Math.floor(this.random() * nm17.length);
			rnd3 = Math.floor(this.random() * nm19.length);
			if (rnd < 3) {
				while (rnd3 < 12) {
					rnd3 = Math.floor(this.random() * nm19.length);
				}
			...
			rnd8 = Math.floor(this.random() * nm17.length);
			rnd9 = Math.floor(this.random() * nm19.length);
