...
module.exports = generatorOf(function generator$miscellaneous$instruments() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 3) {
			...
			rnd4 = Math.floor(this.random() * names4.length);
			...
			rnd3 = Math.floor(this.random() * names3.length);
			rnd4 = Math.floor(this.random() * names4.length);
			rnd5 = Math.floor(this.random() * names9.length);
			rnd6 = Math.floor(this.random() * names8.length);
			...
			rnd4 = Math.floor(this.random() * names4.length);
			rnd5 = Math.floor(this.random() * names5.length);
			rnd6 = Math.floor(this.random() * names4.length);
