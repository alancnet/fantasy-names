...
module.exports = generatorOf(function generator$miscellaneous$noble_houses() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 3) {
			...
			rnd = Math.floor(this.random() * names7.length);
			rnd2 = Math.floor(this.random() * names8.length);
