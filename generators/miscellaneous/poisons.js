...
module.exports = generatorOf(function generator$miscellaneous$poisons() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 2) {
			...
			rnd = Math.floor(this.random() * nma.length);
			rnd2 = Math.floor(this.random() * nmb.length);
			rnd3 = Math.floor(this.random() * nmd.length);
			if (i < 7) {
				while (rnd < 7) {
					rnd = Math.floor(this.random() * nma.length);
				}
				...
				rnd4 = Math.floor(this.random() * nmc.length);
				rnd5 = Math.floor(this.random() * nmb.length);
