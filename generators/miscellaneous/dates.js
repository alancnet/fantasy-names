...
module.exports = generatorOf(function generator$miscellaneous$dates() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 2) {
			...
			rnd9 = Math.floor(this.random() * nm4.length);
			rnd10 = Math.floor(this.random() * nm7.length);
			...
			rnd6b = Math.floor(this.random() * nm6.length);
			rnd7b = Math.floor(this.random() * nm7.length);
			rnd3c = Math.floor(this.random() * nm3.length);
			rnd4c = Math.floor(this.random() * nm4.length);
			rnd5c = Math.floor(this.random() * nm5.length);
			rnd6c = Math.floor(this.random() * nm6.length);
			rnd7c = Math.floor(this.random() * nm7.length);
			if (rnd5 > 6) {
				while (rnd6 === 0) {
					rnd6 = Math.floor(this.random() * nm6.length);
				}
			...
			rnd9 = Math.floor(this.random() * nm9.length);
			rnd8 = Math.floor(this.random() * nm8.length);
