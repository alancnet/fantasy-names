...
module.exports = generatorOf(function generator$miscellaneous$religions() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 3) {
			...
			rnd0 = Math.floor(this.random() * names6.length);
			rnd1 = Math.floor(this.random() * names7.length);
			...
			rnd4 = Math.floor(this.random() * names5.length);
			rnd5 = Math.floor(this.random() * names6.length);
