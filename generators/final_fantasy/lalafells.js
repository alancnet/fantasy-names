...
module.exports = generatorOf(function generator$final_fantasy$lalafells(type) {
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			if (i < 5) {
				...
				rnd3 = Math.floor(this.random() * nm1.length);
			...
			if (i < 5) {
				...
				rnd3 = Math.floor(this.random() * nm1.length);
				rnd4 = Math.floor(this.random() * nm2.length);
				rnd5 = Math.floor(this.random() * nm1.length);
				rnd6 = Math.floor(this.random() * nm2.length);
				rnd7 = Math.floor(this.random() * nm1.length);
				...
				rnd8 = Math.floor(this.random() * nm4.length);
				rnd9 = Math.floor(this.random() * nm1.length);
				rnd10 = Math.floor(this.random() * nm2.length);
				rnd11 = Math.floor(this.random() * nm3.length);
				rnd12 = Math.floor(this.random() * nm5.length);
				if (rnd11 < 15) {
					rnd12 = 0;
				}
				if (rnd11 > 14) {
