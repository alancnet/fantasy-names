...
module.exports = generatorOf(function generator$final_fantasy$miqotes(type) {
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			if (i < 5) {
				...
				rnd11 = Math.floor(this.random() * nm5.length);
				rnd12 = Math.floor(this.random() * nm7.length);
				rnd13 = Math.floor(this.random() * nm6.length);
				rnd14 = Math.floor(this.random() * nm5.length);
				if (rnd11 === 1) {
					rnd14 = 0;
				}
				...
				rnd16 = Math.floor(this.random() * nm9.length);
				rnd17 = Math.floor(this.random() * nm5.length);
				if (rnd11 === 1 || rnd14 === 1) {
					rnd17 = 0;
				}
				rnd18 = Math.floor(this.random() * nm10.length);
				if (rnd16 < 16) {
					rnd17 = 0;
					rnd18 = 0;
				} else {
				...
				rnd19 = Math.floor(this.random() * nm11.length);
				...
				rnd8 = Math.floor(this.random() * nm5.length);
				if (rnd8 < 5) {
					rnd6 = 0;
					while (rnd5 < 3) {
						rnd5 = Math.floor(this.random() * nm4.length);
