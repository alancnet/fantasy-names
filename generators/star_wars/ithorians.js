...
module.exports = generatorOf(function generator$star_wars$ithorians(type) {
	...
	i = Math.floor(this.random() * 10); {
		...
		rnd10 = Math.floor(this.random() * nm12.length);
		if (i % 3 === 0 && i % 2 != 0) {
			while (rnd7 < 3) {
				rnd7 = Math.floor(this.random() * nm9.length);
			}
			...
			rnd9 = Math.floor(this.random() * nm10.length);
			rnd11 = Math.floor(this.random() * nm11.length);
			rnd12 = Math.floor(this.random() * nm10.length);
		...
		if (type === 1) {
			...
			if (i < 4) {
				...
				rnd3 = Math.floor(this.random() * nm7.length);
				rnd4 = Math.floor(this.random() * nm6.length);
				rnd5b = Math.floor(this.random() * nm7.length);
			...
			if (i < 4) {
				...
				rnd3 = Math.floor(this.random() * nm3.length);
				rnd4 = Math.floor(this.random() * nm2.length);
				rnd5b = Math.floor(this.random() * nm3.length);
