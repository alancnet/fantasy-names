...
module.exports = generatorOf(function generator$star_wars$tusken_raiders(type) {
	...
	i = Math.floor(this.random() * 10); {
		rnd7 = Math.floor(this.random() * nm16.length);
		rnd8 = Math.floor(this.random() * nm17.length);
		rnd10 = Math.floor(this.random() * nm19.length);
		if (i % 2 != 0) {
			namelast = nm16[rnd7] + nm17[rnd8] + nm19[rnd10];
		} else {
			rnd9 = Math.floor(this.random() * nm17.length);
		...
		if (type === 1) {
			...
			rnd3 = Math.floor(this.random() * nm13.length);
			if (i < 5) {
				rnd = Math.floor(this.random() * nm1.length);
				rnd4 = Math.floor(this.random() * nm15.length);
			...
			if (i < 5) {
				...
				rnd2 = Math.floor(this.random() * nm7.length);
