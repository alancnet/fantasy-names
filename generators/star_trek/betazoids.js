...
module.exports = generatorOf(function generator$star_trek$betazoids(type) {
	var nm1 = ["a", "e", "i", "o", "u", "", "", "", "", "", ""];
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			if (i < 5) {
				rnd = Math.floor(this.random() * nm7.length);
				rnd2 = Math.floor(this.random() * nm8.length);
				rnd3 = Math.floor(this.random() * nm9.length);
				rnd4 = Math.floor(this.random() * nm10.length);
				rnd5 = Math.floor(this.random() * nm12.length);
				rnd6 = Math.floor(this.random() * nm13.length);
				rnd7 = Math.floor(this.random() * nm14.length);
				rnd8 = Math.floor(this.random() * nm15.length);
				rnd9 = Math.floor(this.random() * nm16.length);
				rnd10 = Math.floor(this.random() * nm5.length);
				rnd11 = Math.floor(this.random() * nm17.length);
				...
				rnd6 = Math.floor(this.random() * nm10.length);
				rnd7 = Math.floor(this.random() * nm12.length);
				rnd8 = Math.floor(this.random() * nm13.length);
				rnd9 = Math.floor(this.random() * nm14.length);
				rnd10 = Math.floor(this.random() * nm15.length);
				rnd12 = Math.floor(this.random() * nm17.length);
			...
			if (i < 5) {
				...
				rnd8 = Math.floor(this.random() * nm14.length);
				rnd9 = Math.floor(this.random() * nm15.length);
				rnd11 = Math.floor(this.random() * nm17.length);
