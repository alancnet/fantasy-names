...
module.exports = generatorOf(function generator$star_trek$klingons(type) {
	var nm1 = ["a", "o", "u", "e"];
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			if (i < 4) {
				...
				rnd5 = Math.floor(this.random() * nm12.length);
				rnd6 = Math.floor(this.random() * nm7.length);
				rnd7 = Math.floor(this.random() * nm8.length);
				if (rnd6 === 0) {
					rnd7 = 0;
				}
				rnd8 = Math.floor(this.random() * nm13.length);
				rnd9 = Math.floor(this.random() * nm3.length);
				rnd10 = Math.floor(this.random() * nm14.length);
				rnd11 = Math.floor(this.random() * nm3.length);
				rnd12 = Math.floor(this.random() * nm15.length);
				rnd13 = Math.floor(this.random() * nm6.length);
				...
				rnd4 = Math.floor(this.random() * nm3.length);
				...
				rnd9 = Math.floor(this.random() * nm13.length);
				rnd10 = Math.floor(this.random() * nm3.length);
				rnd13 = Math.floor(this.random() * nm15.length);
				rnd12 = Math.floor(this.random() * nm6.length);
				...
				rnd4 = Math.floor(this.random() * nm12.length);
