...
module.exports = generatorOf(function generator$places$jungles() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 6) {
			...
			rnd = Math.floor(this.random() * names3.length);
			rnd2 = Math.floor(this.random() * names4.length);
			rnd3 = Math.floor(this.random() * names7.length);
			...
			rnd5 = Math.floor(this.random() * names7.length);
