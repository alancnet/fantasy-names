...
module.exports = generatorOf(function generator$dragon_age$dwarfs(type) {
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			rnd0 = Math.floor(this.random() * namesFemale.length);
			rnd1 = Math.floor(this.random() * namesFemale2.length);
			...
			rnd0 = Math.floor(this.random() * namesMale.length);
			rnd1 = Math.floor(this.random() * namesFamily.length);
			rnd2 = Math.floor(this.random() * names3.length);
			rnd3 = Math.floor(this.random() * names4.length);
