...
module.exports = generatorOf(function generator$elder_scrolls$dragons() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 8) {
			rnd = parseInt(Math.floor((this.random() * names1.length)));
			rnd2 = parseInt(Math.floor((this.random() * names1.length)));
			while (rnd2 === rnd) {
				rnd2 = parseInt(Math.floor((this.random() * names1.length)));
			}
			rnd3 = parseInt(Math.floor((this.random() * names1.length)));
			...
			rnd2 = parseInt(Math.floor((this.random() * names1.length)));
			while (rnd2 === rnd) {
				rn22 = parseInt(Math.floor((this.random() * names1.length)));
			}
