...
module.exports = generatorOf(function generator$towns_and_cities$citys() {
	...
	i = Math.floor(this.random() * 10); {
		if (i < 3) {
			...
			rnd3 = Math.floor(this.random() * names5.length);
			rnd4 = Math.floor(this.random() * names7.length);
			names = names1[rnd0] + names2[rnd1] + names3[rnd2] + names5[rnd3] + names7[rnd4];
		} else if (i < 5) {
			rnd2 = Math.floor(this.random() * names3.length);
			rnd3 = Math.floor(this.random() * names4.length);
			rnd4 = Math.floor(this.random() * names3.length);
			rnd5 = Math.floor(this.random() * names5.length);
			rnd6 = Math.floor(this.random() * names7.length);
			...
			rnd2 = Math.floor(this.random() * names3.length);
			rnd3 = Math.floor(this.random() * names4.length);
			rnd4 = Math.floor(this.random() * names6.length);
