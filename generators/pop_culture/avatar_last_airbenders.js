...
module.exports = generatorOf(function generator$pop_culture$avatar_last_airbenders(type) {
	...
	i = Math.floor(this.random() * 12); {
		if (type === 1) {
			if (i < 3) {
				...
				rnd5 = Math.floor(this.random() * nm14.length);
				rnd6 = Math.floor(this.random() * nm13.length);
				...
				rnd = Math.floor(this.random() * nm19b.length);
				rnd2 = Math.floor(this.random() * nm2.length);
				rnd3 = Math.floor(this.random() * nm21.length);
				names = nm19b[rnd] + nm2[rnd2] + nm21[rnd3];
			} else if (i < 10) {
				rnd = Math.floor(this.random() * nm25.length);
				rnd2 = Math.floor(this.random() * nm2.length);
				rnd3 = Math.floor(this.random() * nm26.length);
				rnd4 = Math.floor(this.random() * nm2.length);
				rnd5 = Math.floor(this.random() * nm26.length);
				...
				rnd2 = Math.floor(this.random() * nm2.length);
				rnd3 = Math.floor(this.random() * nm2.length);
			...
			if (i < 3) {
				...
				rnd2 = Math.floor(this.random() * nm2.length);
				rnd3 = Math.floor(this.random() * nm23.length);
				rnd4 = Math.floor(this.random() * nm2.length);
				rnd5 = Math.floor(this.random() * nm24.length);
				if (rnd < 2) {
					while (rnd5 < 2) {
						rnd5 = Math.floor(this.random() * nm24.length);
					}
