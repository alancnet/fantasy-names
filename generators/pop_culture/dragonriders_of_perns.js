...
module.exports = generatorOf(function generator$pop_culture$dragonriders_of_perns(type) {
		...
		if (type === 1) {
			...
			if (i < 5) {
				...
				if (i < 3) {
					...
					rnd7 = Math.floor(this.random() * nm10.length);
				...
				rnd4 = Math.floor(this.random() * nm14.length);
				if (i < 8) {
					names = nm13[rnd] + nm14[rnd2] + nm15[rnd3] + nm14[rnd4] + nm12[rnd5];
				} else {
					rnd6 = Math.floor(this.random() * nm15.length);
