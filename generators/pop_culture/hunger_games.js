...
module.exports = generatorOf(function generator$pop_culture$hunger_games(type) {
	...
	var nmN = ["Acee", "Acey", "Alder", "Allio", "Allium", "Amaran", "Amaryll", "Amaryllis", "Ambro", "Ash", "Azo", "Bauble", "Beade", "Birch", "Birr", "Birre", "Brier", "Cabe", "Cabel", "Cabil", "Chrysan", "Clove", "Coile", "Coilee", "Cornel", "Cornell", "Cresh", "Cress", "Deecee", "Deecey", "Deezee", "Duscle", "Dussel", "Edel", "Fennal", "Fennel", "Flaxe", "Gadget", "Gimmick", "Glinte", "Haldi", "Haldin", "Hibis", "Jolt", "Keek", "Kinnik", "Lavenne", "Leome", "Light", "Mesqi", "Mesquite", "Mimo", "Mimosa", "Morel", "Morrel", "Mox", "Neam", "Neem", "Nemo", "Nettle", "Osa", "Parsley", "Parsnip", "Paslee", "Pasnip", "Pea", "Pista", "Pocan", "Poplaire", "Prong", "Riggee", "Riggs", "Rye", "Saffran", "Saffrin", "Saffron", "Sarrel", "Sorrel", "Spark", "Sparkle", "Sparks", "Syca", "Sycamo", "Sycamore", "Tazzel", "Thist", "Trifle", "Trillium", "Trilly", "Trink", "Trinkee", "Trinket", "Trinks", "Tuls", "Tulsee", "Vender"];
	var nm4 = ["Amber", "Ash", "Bell", "Bright", "Bronze", "Clear", "Common", "Copper", "Dawn", "Day", "Dusk", "Earth", "Ever", "Fair", "Far", "Flat", "Gallo", "Green", "Hard", "Hawk", "Heaven", "Keen", "Little", "Lock", "Low", "Meadow", "Mild", "Night", "Ocean", "Over", "Peace", "Pit", "Plain", "River", "Rose", "Sea", "Silent", "Silver", "Single", "Sky", "Solid", "Spotted", "Spring", "Steel", "Thorne", "Under", "Well", "Wheat", "White", "Wild"];
	var nm5 = ["berg", "berry", "bloom", "blossom", "brand", "breath", "breeze", "brook", "bush", "creek", "drop", "dust", "fall", "feather", "flake", "forest", "forge", "gaze", "grove", "hair", "heart", "hill", "horn", "leaf", "lock", "mark", "path", "petal", "rock", "root", "sand", "scape", "shire", "smith", "snow", "song", "star", "stone", "thorn", "tide", "tree", "vale", "ville", "water", "way", "willow", "wind", "wing", "wood", "worth"];


	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			rnd = Math.floor(this.random() * nmF.length);
			rnd2 = Math.floor(this.random() * nm4.length);
			rnd3 = Math.floor(this.random() * nm5.length);
			names = nmF[rnd] + " " + nm4[rnd2] + nm5[rnd3];
		} else if (type === 2) {
			rnd = Math.floor(this.random() * nmN.length);
			rnd2 = Math.floor(this.random() * nm4.length);
			rnd3 = Math.floor(this.random() * nm5.length);
			names = nmN[rnd] + " " + nm4[rnd2] + nm5[rnd3];
		} else {
			rnd = Math.floor(this.random() * nmM.length);
			rnd2 = Math.floor(this.random() * nm4.length);
			rnd3 = Math.floor(this.random() * nm5.length);
