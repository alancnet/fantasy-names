...
module.exports = generatorOf(function generator$pop_culture$hyborians(type) {
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			if (i < 2) {
				...
				rnd = Math.floor(this.random() * nm11.length);
				rnd2 = Math.floor(this.random() * nm12.length);
			...
			if (i < 2) {
				...
				rnd = Math.floor(this.random() * nm13.length);
				rnd2 = Math.floor(this.random() * nm14.length);
				names = nm13[rnd] + nm14[rnd2];
			} else {
				rnd = Math.floor(this.random() * nm17.length);
				rnd2 = Math.floor(this.random() * nm18.length);
