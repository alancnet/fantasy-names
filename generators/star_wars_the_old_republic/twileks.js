...
module.exports = generatorOf(function generator$star_wars_the_old_republic$twileks(type) {
	...
	i = Math.floor(this.random() * 10); {
		...
		rnd7 = Math.floor(this.random() * nm3.length);
		...
		if (type === 1) {
			...
			rnd10 = Math.floor(this.random() * nm10.length);
