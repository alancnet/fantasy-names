...
module.exports = generatorOf(function generator$star_wars_the_old_republic$cathars(type) {
	var nm1 = ["", "", "a", "u", "y", "i"];
	...
	i = Math.floor(this.random() * 10); {
		if (i < 5) {
			rn = Math.floor(this.random() * nm10.length);
			rn2 = Math.floor(this.random() * nm14.length);
			rn3 = Math.floor(this.random() * nm11.length);
			rn4 = Math.floor(this.random() * nm12.length);
			rn5 = Math.floor(this.random() * nm11.length);
			rn6 = Math.floor(this.random() * nm13.length);
