...
module.exports = generatorOf(function generator$mass_effect$salarians(type) {
	...
	i = Math.floor(this.random() * 10); {
		...
		rnd5 = Math.floor(this.random() * names1.length);
		while (rnd5 === "") {
			rnd5 = Math.floor(this.random() * names1.length);
		}
		rnd6 = Math.floor(this.random() * names2.length);
		rnd7 = Math.floor(this.random() * names6.length);
		rnd8 = Math.floor(this.random() * names7.length);
