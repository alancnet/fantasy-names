...
module.exports = generatorOf(function generator$mass_effect$quarians(type) {
	...
	i = Math.floor(this.random() * 10); {
		...
		rnd3 = Math.floor(this.random() * names4.length);
		rnd4 = Math.floor(this.random() * names5.length);
		rnd5 = Math.floor(this.random() * names2.length);
		rnd6 = Math.floor(this.random() * names6.length);
		rnd7 = Math.floor(this.random() * names7.length);
		rnd8 = Math.floor(this.random() * names5.length);
		rnd9 = Math.floor(this.random() * names2.length);
		rnd10 = Math.floor(this.random() * names8.length);
