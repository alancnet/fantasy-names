...
module.exports = generatorOf(function generator$doctor_who$gallifreyans(type) {
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			if (i < 4) {
				...
				rnd9 = Math.floor(this.random() * nm12.length);
				rnd10 = Math.floor(this.random() * nm2.length);
				rnd11 = Math.floor(this.random() * nm13.length);
				...
				rnd9 = Math.floor(this.random() * nm12.length);
				rnd10 = Math.floor(this.random() * nm2.length);
				rnd11 = Math.floor(this.random() * nm12.length);
				rnd12 = Math.floor(this.random() * nm2.length);
				rnd13 = Math.floor(this.random() * nm13.length);
				...
				rnd11 = Math.floor(this.random() * nm12.length);
				rnd12 = Math.floor(this.random() * nm2.length);
				rnd13 = Math.floor(this.random() * nm12.length);
				rnd14 = Math.floor(this.random() * nm2.length);
				rnd15 = Math.floor(this.random() * nm13.length);
			...
			if (i < 4) {
				...
				rnd8 = Math.floor(this.random() * nm2.length);
				rnd9 = Math.floor(this.random() * nm6.length);
				rnd10 = Math.floor(this.random() * nm2.length);
				rnd11 = Math.floor(this.random() * nm7.length);
				...
				rnd9 = Math.floor(this.random() * nm6.length);
				rnd10 = Math.floor(this.random() * nm2.length);
				rnd11 = Math.floor(this.random() * nm6.length);
				rnd12 = Math.floor(this.random() * nm2.length);
				rnd13 = Math.floor(this.random() * nm7.length);
				...
				rnd14 = Math.floor(this.random() * nm2.length);
				rnd15 = Math.floor(this.random() * nm7.length);
