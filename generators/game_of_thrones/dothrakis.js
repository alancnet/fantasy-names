...
module.exports = generatorOf(function generator$game_of_thrones$dothrakis(type) {
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			if (i < 5) {
				rnd = Math.floor(this.random() * namesFemale.length);
				names = namesFemale[rnd];
			} else {
				rnd = Math.floor(this.random() * namesF1.length);
				rnd2 = Math.floor(this.random() * namesF2.length);
				rnd3 = Math.floor(this.random() * namesF3.length);
				rnd4 = Math.floor(this.random() * namesF4.length);
				rnd5 = Math.floor(this.random() * namesF5.length);
				if (rnd < 4) {
					while (rnd2 === 0) {
						rnd2 = Math.floor(this.random() * namesF2.length);
					}
			...
			if (i < 5) {
				rnd = Math.floor(this.random() * namesMale.length);
				names = namesMale[rnd];
			} else {
				rnd = Math.floor(this.random() * namesM1.length);
				rnd2 = Math.floor(this.random() * namesM2.length);
				rnd3 = Math.floor(this.random() * namesM3.length);
				rnd4 = Math.floor(this.random() * namesM4.length);
				rnd5 = Math.floor(this.random() * namesM5.length);
				if (rnd < 5) {
					while (rnd2 === 0) {
						rnd2 = Math.floor(this.random() * namesM2.length);
					}
