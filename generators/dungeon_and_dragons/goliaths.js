...
module.exports = generatorOf(function generator$dungeon_and_dragons$goliaths(type) {
	...
	i = Math.floor(this.random() * 10); {
		if (type === 1) {
			rnd = Math.floor(this.random() * namesFemF.length);
			rnd2 = Math.floor(this.random() * namesFemL.length);
			rnd3 = Math.floor(this.random() * namesMid.length);
			rnd4 = Math.floor(this.random() * namesSurF.length);
			rnd5 = Math.floor(this.random() * namesSurL.length);
			names = namesFemF[rnd] + namesFemL[rnd2] + " " + namesMid[rnd3] + " " + namesSurF[rnd4] + namesSurL[rnd5];
		} else {
			rnd = Math.floor(this.random() * namesMaleF.length);
			rnd2 = Math.floor(this.random() * namesMaleL.length);
			rnd3 = Math.floor(this.random() * namesMid.length);
			rnd4 = Math.floor(this.random() * namesSurF.length);
			rnd5 = Math.floor(this.random() * namesSurL.length);
