...
module.exports = generatorOf(function generator$pathfinder$tians(type) {
	/* Tian-Dan - Vietnamese */
	...
	i = Math.floor(this.random() * 14); {
		if (type === 1) {
			if (i < 2) {
				rnd = Math.floor(this.random() * nm4.length);
				...
				rnd6 = Math.floor(this.random() * nm9.length);
				names = nm7[rnd4] + nm8[rnd5] + nm9[rnd6] + "  " + nm4[rnd] + nm5[rnd2] + nm6[rnd3];
			} else if (i < 4) {
				rnd = Math.floor(this.random() * nm14.length);
				rnd2 = Math.floor(this.random() * nm11.length);
				rnd3 = Math.floor(this.random() * nm15.length);
				rnd4 = Math.floor(this.random() * nm11.length);
				rnd5 = Math.floor(this.random() * nm16.length);
				rnd6 = Math.floor(this.random() * nm17.length);
				rnd7 = Math.floor(this.random() * nm18.length);
				rnd8 = Math.floor(this.random() * nm19.length);
				names = nm17[rnd6] + nm18[rnd7] + nm19[rnd8] + "  " + nm14[rnd] + nm11[rnd2] + nm15[rnd3] + nm11[rnd4] + nm16[rnd5];
			} else if (i < 6) {
				rnd = Math.floor(this.random() * nm23.length);
				rnd2 = Math.floor(this.random() * nm24.length);
				rnd3 = Math.floor(this.random() * nm25.length);
				rnd4 = Math.floor(this.random() * nm26.length);
				names = nm26[rnd4] + "  " + nm23[rnd] + nm24[rnd2] + "  " + nm25[rnd3];
			} else if (i < 8) {
				rnd = Math.floor(this.random() * nm31.length);
				rnd2 = Math.floor(this.random() * nm32.length);
				rnd3 = Math.floor(this.random() * nm33.length);
				rnd4 = Math.floor(this.random() * nm32.length);
				rnd5 = Math.floor(this.random() * nm34.length);
				if (rnd < 3) {
					while (rnd5 < 3) {
						rnd5 = Math.floor(this.random() * nm34.length);
					}
				...
				rnd = Math.floor(this.random() * nm37.length);
				rnd2 = Math.floor(this.random() * nm38.length);
				rnd3 = Math.floor(this.random() * nm39.length);
				rnd4 = Math.floor(this.random() * nm40.length);
				names = nm39[rnd3] + nm40[rnd4] + "  " + nm37[rnd] + nm38[rnd2];
			} else if (i < 12) {
				rnd = Math.floor(this.random() * nm45.length);
				rnd2 = Math.floor(this.random() * nm46.length);
				rnd3 = Math.floor(this.random() * nm47.length);
				rnd4 = Math.floor(this.random() * nm46.length);
				rnd5 = Math.floor(this.random() * nm44.length);
				rnd6 = Math.floor(this.random() * nm48.length);
				rnd7 = Math.floor(this.random() * nm49.length);
			...
			if (i < 2) {
				...
				rnd = Math.floor(this.random() * nm10.length);
				rnd2 = Math.floor(this.random() * nm11.length);
				rnd3 = Math.floor(this.random() * nm12.length);
				rnd4 = Math.floor(this.random() * nm11.length);
				rnd5 = Math.floor(this.random() * nm13.length);
				rnd6 = Math.floor(this.random() * nm17.length);
				rnd7 = Math.floor(this.random() * nm18.length);
				rnd8 = Math.floor(this.random() * nm19.length);
				names = nm17[rnd6] + nm18[rnd7] + nm19[rnd8] + "  " + nm10[rnd] + nm11[rnd2] + nm12[rnd3] + nm11[rnd4] + nm13[rnd5];
			} else if (i < 6) {
				rnd = Math.floor(this.random() * nm20.length);
				rnd2 = Math.floor(this.random() * nm21.length);
				rnd3 = Math.floor(this.random() * nm22.length);
				rnd4 = Math.floor(this.random() * nm26.length);
				names = nm26[rnd4] + "  " + nm20[rnd] + nm21[rnd2] + "  " + nm22[rnd3];
			} else if (i < 8) {
				rnd = Math.floor(this.random() * nm27.length);
				rnd2 = Math.floor(this.random() * nm28.length);
				rnd3 = Math.floor(this.random() * nm29.length);
				rnd4 = Math.floor(this.random() * nm28.length);
				rnd5 = Math.floor(this.random() * nm30.length);
				if (rnd < 3) {
					while (rnd5 < 3) {
						rnd5 = Math.floor(this.random() * nm30.length);
					}
				...
				rnd = Math.floor(this.random() * nm35.length);
				rnd2 = Math.floor(this.random() * nm36.length);
				rnd3 = Math.floor(this.random() * nm39.length);
				rnd4 = Math.floor(this.random() * nm40.length);
				names = nm39[rnd3] + nm40[rnd4] + "  " + nm35[rnd] + nm36[rnd2];
			} else if (i < 12) {
				rnd = Math.floor(this.random() * nm41.length);
				rnd2 = Math.floor(this.random() * nm42.length);
				rnd3 = Math.floor(this.random() * nm43.length);
				rnd4 = Math.floor(this.random() * nm42.length);
				rnd5 = Math.floor(this.random() * nm44.length);
				rnd6 = Math.floor(this.random() * nm48.length);
				rnd7 = Math.floor(this.random() * nm49.length);
				names = nm48[rnd6] + nm49[rnd7] + "  " + nm41[rnd] + nm42[rnd2] + nm43[rnd3] + nm42[rnd4] + nm44[rnd5];
			} else {
				rnd = Math.floor(this.random() * nm50.length);
				rnd2 = Math.floor(this.random() * nm51.length);
				rnd3 = Math.floor(this.random() * nm52.length);
				rnd4 = Math.floor(this.random() * nm51.length);
				rnd5 = Math.floor(this.random() * nm53.length);
