...
module.exports = generatorOf(function generator$pathfinder$humans(type) {
	/* Kellid */
	...
	i = Math.floor(this.random() * 12); {
		if (type === 1) {
			if (i < 2) {
				...
				rnd = Math.floor(this.random() * nm12.length);
				rnd2 = Math.floor(this.random() * nm13.length);
				rnd3 = Math.floor(this.random() * nm14.length);
				rnd4 = Math.floor(this.random() * nm13.length);
				rnd5 = Math.floor(this.random() * nm15.length);
				rnd6 = Math.floor(this.random() * nm16.length);
				rnd7 = Math.floor(this.random() * nm17.length);
				names = nm12[rnd] + nm13[rnd2] + nm14[rnd3] + nm13[rnd4] + nm15[rnd5] + " " + nm16[rnd6] + nm17[rnd7];
			} else if (i < 6) {
				rnd = Math.floor(this.random() * nm22.length);
				rnd2 = Math.floor(this.random() * nm23.length);
				rnd3 = Math.floor(this.random() * nm24.length);
				rnd4 = Math.floor(this.random() * nm23.length);
				rnd5 = Math.floor(this.random() * nm25.length);
				rnd6 = Math.floor(this.random() * nm26.length);
				rnd7 = Math.floor(this.random() * nm27.length);
				rnd8 = Math.floor(this.random() * nm28.length);
				rnd9 = Math.floor(this.random() * nm27.length);
				rnd10 = Math.floor(this.random() * nm29.length);
				names = nm22[rnd] + nm23[rnd2] + nm24[rnd3] + nm23[rnd4] + nm25[rnd5] + " " + nm26[rnd6] + nm27[rnd7] + nm28[rnd8] + nm27[rnd9] + nm28[rnd10];
			} else if (i < 8) {
				rnd = Math.floor(this.random() * nm34.length);
				rnd2 = Math.floor(this.random() * nm35.length);
				rnd3 = Math.floor(this.random() * nm36.length);
				rnd4 = Math.floor(this.random() * nm35.length);
				rnd5 = Math.floor(this.random() * nm37.length);
				rnd6 = Math.floor(this.random() * nm38.length);
				rnd7 = Math.floor(this.random() * nm39.length);
				rnd8 = Math.floor(this.random() * nm40.length);
				rnd9 = Math.floor(this.random() * nm39.length);
				rnd10 = Math.floor(this.random() * nm41.length);
				names = nm34[rnd] + nm35[rnd2] + nm36[rnd3] + nm35[rnd4] + nm37[rnd5] + " " + nm38[rnd6] + nm39[rnd7] + nm40[rnd8] + nm39[rnd9] + nm41[rnd10];
			} else if (i < 10) {
				rnd = Math.floor(this.random() * nm46.length);
				rnd2 = Math.floor(this.random() * nm47.length);
				rnd3 = Math.floor(this.random() * nm48.length);
				rnd4 = Math.floor(this.random() * nm47.length);
				rnd5 = Math.floor(this.random() * nm49.length);
				rnd6 = Math.floor(this.random() * nm50.length);
				rnd7 = Math.floor(this.random() * nm51.length);
				rnd8 = Math.floor(this.random() * nm52.length);
				rnd9 = Math.floor(this.random() * nm51.length);
				rnd10 = Math.floor(this.random() * nm53.length);
				names = nm46[rnd] + nm47[rnd2] + nm48[rnd3] + nm47[rnd4] + nm49[rnd5] + " " + nm50[rnd6] + nm51[rnd7] + nm52[rnd8] + nm51[rnd9] + nm53[rnd10];
			} else {
				rnd = Math.floor(this.random() * nm58.length);
				rnd2 = Math.floor(this.random() * nm59.length);
				rnd3 = Math.floor(this.random() * nm60.length);
				rnd4 = Math.floor(this.random() * nm59.length);
				rnd5 = Math.floor(this.random() * nm61.length);
				rnd6 = Math.floor(this.random() * nm62.length);
				rnd7 = Math.floor(this.random() * nm63.length);
				rnd8 = Math.floor(this.random() * nm64.length);
				rnd9 = Math.floor(this.random() * nm63.length);
				rnd10 = Math.floor(this.random() * nm65.length);
			...
			if (i < 2) {
				...
				rnd = Math.floor(this.random() * nm8.length);
				rnd2 = Math.floor(this.random() * nm9.length);
				rnd3 = Math.floor(this.random() * nm10.length);
				rnd4 = Math.floor(this.random() * nm9.length);
				rnd5 = Math.floor(this.random() * nm11.length);
				rnd6 = Math.floor(this.random() * nm16.length);
				rnd7 = Math.floor(this.random() * nm17.length);
				names = nm8[rnd] + nm9[rnd2] + nm10[rnd3] + nm9[rnd4] + nm11[rnd5] + " " + nm16[rnd6] + nm17[rnd7];
			} else if (i < 6) {
				rnd = Math.floor(this.random() * nm18.length);
				rnd2 = Math.floor(this.random() * nm19.length);
				rnd3 = Math.floor(this.random() * nm20.length);
				rnd4 = Math.floor(this.random() * nm19.length);
				rnd5 = Math.floor(this.random() * nm21.length);
				rnd6 = Math.floor(this.random() * nm26.length);
				rnd7 = Math.floor(this.random() * nm27.length);
				rnd8 = Math.floor(this.random() * nm28.length);
				rnd9 = Math.floor(this.random() * nm27.length);
				...
				rnd = Math.floor(this.random() * nm30.length);
				rnd2 = Math.floor(this.random() * nm31.length);
				rnd3 = Math.floor(this.random() * nm32.length);
				rnd4 = Math.floor(this.random() * nm31.length);
				rnd5 = Math.floor(this.random() * nm33.length);
				rnd6 = Math.floor(this.random() * nm38.length);
				rnd7 = Math.floor(this.random() * nm39.length);
				rnd8 = Math.floor(this.random() * nm40.length);
				rnd9 = Math.floor(this.random() * nm39.length);
				...
				rnd = Math.floor(this.random() * nm42.length);
				rnd2 = Math.floor(this.random() * nm43.length);
				rnd3 = Math.floor(this.random() * nm44.length);
				rnd4 = Math.floor(this.random() * nm43.length);
				rnd5 = Math.floor(this.random() * nm45.length);
				rnd6 = Math.floor(this.random() * nm50.length);
				rnd7 = Math.floor(this.random() * nm51.length);
				rnd8 = Math.floor(this.random() * nm52.length);
				rnd9 = Math.floor(this.random() * nm51.length);
				...
				rnd = Math.floor(this.random() * nm54.length);
				rnd2 = Math.floor(this.random() * nm55.length);
				rnd3 = Math.floor(this.random() * nm56.length);
				rnd4 = Math.floor(this.random() * nm55.length);
				rnd5 = Math.floor(this.random() * nm57.length);
				rnd6 = Math.floor(this.random() * nm62.length);
				rnd7 = Math.floor(this.random() * nm63.length);
				rnd8 = Math.floor(this.random() * nm64.length);
				rnd9 = Math.floor(this.random() * nm63.length);
