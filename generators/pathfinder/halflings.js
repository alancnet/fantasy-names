...
module.exports = generatorOf(function generator$pathfinder$halflings(type) {
	...
	i = Math.floor(this.random() * 10); {
		...
		if (i % 3 === 0 && i % 2 != 0) {
			rnd13 = Math.floor(this.random() * nm11.length);
			rnd14 = Math.floor(this.random() * nm10.length);
			rnd15 = Math.floor(this.random() * nm11.length);
			rnd16 = Math.floor(this.random() * nm10.length);
			...
			rnd14 = Math.floor(this.random() * nm14.length);
