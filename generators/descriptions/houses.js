...
module.exports = generatorOf(function generator$descriptions$houses() {
	...
	var rnd8 = Math.floor(this.random() * nm8e.length);
	if (rnd7 === 0) {
		rnd8 = Math.floor(this.random() * nm8a.length);
		nms8 = nm8a[rnd8];
	} else if (rnd7 === 1) {
		rnd8 = Math.floor(this.random() * nm8b.length);
		nms8 = nm8b[rnd8];
	} else if (rnd7 === 2) {
		rnd8 = Math.floor(this.random() * nm8c.length);
		nms8 = nm8c[rnd8];
	} else if (rnd7 === 3) {
		rnd8 = Math.floor(this.random() * nm8d.length);
		nms8 = nm8d[rnd8];
	} else {
		nms8 = nm8e[rnd8];
	}
	var rnd9 = Math.floor(this.random() * nm9.length);
	var rnd10 = Math.floor(this.random() * nm10a.length);
	if (rnd9 === 1) {
		rnd10 = Math.floor(this.random() * nm10b.length);
		nms10 = nm10b[rnd10];
	} else if (rnd9 === 2) {
		rnd10 = Math.floor(this.random() * nm10c.length);
		nms10 = nm10c[rnd10];
	} else {
		nms10 = nm10a[rnd10];
	}
	...
	var rnd25 = Math.floor(this.random() * nm21.length);
