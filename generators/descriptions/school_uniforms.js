...
module.exports = generatorOf(function generator$descriptions$school_uniforms() {
	...
	var rnd3s = Math.floor(this.random() * nm3s.length);
	...
	var rnd10b = Math.floor(this.random() * nm10.length);
	...
	var rnd16s = Math.floor(this.random() * nm16s.length);
