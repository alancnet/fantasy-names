...
module.exports = generatorOf(function generator$descriptions$flags() {
	...
	while (random3 === random2) {
		random3 = parseInt(Math.floor((this.random() * names3.length)));
	}
	var random4 = parseInt(Math.floor((this.random() * names4.length)));
	while (random4 === random2 || random4 === random3) {
		random4 = parseInt(Math.floor((this.random() * names4.length)));
	}
	...
	var random10 = parseInt(Math.floor((this.random() * names9.length)));
	while (random10 === random9) {
		random10 = parseInt(Math.floor((this.random() * names9.length)));
	}
	var random11 = parseInt(Math.floor((this.random() * names9.length)));
	while (random11 === random9 || random11 === random10) {
		random11 = parseInt(Math.floor((this.random() * names9.length)));
	}

	var random12 = parseInt(Math.floor((this.random() * names1.length)));
	var random13 = parseInt(Math.floor((this.random() * names2.length)));
	var random14 = parseInt(Math.floor((this.random() * names3.length)));
	while (random14 === random13) {
		random14 = parseInt(Math.floor((this.random() * names3.length)));
	}
	var random15 = parseInt(Math.floor((this.random() * names4.length)));
	while (random15 === random13 || random15 === random14) {
		random15 = parseInt(Math.floor((this.random() * names4.length)));
	}
	var random16 = parseInt(Math.floor((this.random() * names5.length)));
	while (random16 === random13 || random16 === random14 || random16 === random15) {
		random16 = parseInt(Math.floor((this.random() * names5.length)));
	}
	var random17 = parseInt(Math.floor((this.random() * names6.length)));
	var random18 = parseInt(Math.floor((this.random() * names7.length)));
	var random19 = parseInt(Math.floor((this.random() * names8.length)));

	var random20 = parseInt(Math.floor((this.random() * names9.length)));
	var random21 = parseInt(Math.floor((this.random() * names9.length)));
	while (random21 === random20) {
		random21 = parseInt(Math.floor((this.random() * names9.length)));
	}
	var random22 = parseInt(Math.floor((this.random() * names9.length)));
	while (random22 === random20 || random22 === random21) {
		random22 = parseInt(Math.floor((this.random() * names9.length)));
	}
