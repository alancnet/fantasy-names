...
module.exports = generatorOf(function generator$descriptions$diseases() {
	...
	while (rnd3d === rnd3a || rnd3d === rnd3b || rnd3d === rnd3c) {
		rnd3d = Math.floor(this.random() * nm3.length);
	}
	var rnd3e = Math.floor(this.random() * nm3.length);
	while (rnd3e === rnd3a || rnd3e === rnd3b || rnd3e === rnd3c || rnd3e === rnd3d) {
		rnd3e = Math.floor(this.random() * nm3.length);
	}
	...
	while (rnd15 === rnd14a || rnd15 === rnd14b) {
		rnd15 = Math.floor(this.random() * nm15.length);
	}
