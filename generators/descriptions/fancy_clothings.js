...
module.exports = generatorOf(function generator$descriptions$fancy_clothings(type) {
	...
	if (type === 1) {
		var rnd1 = Math.floor(this.random() * ns1.length);
		var rnd2 = Math.floor(this.random() * ns2.length);
		var rnd3 = Math.floor(this.random() * ns3.length);
		var rnd4 = Math.floor(this.random() * ns4.length);
		var rnd5 = Math.floor(this.random() * ns5.length);
		var rnd6 = Math.floor(this.random() * ns6.length);
		var rnd7 = Math.floor(this.random() * ns7.length);
		var rnd9 = Math.floor(this.random() * ns9.length);
		var rnd10 = Math.floor(this.random() * ns10.length);
		var rnd11 = Math.floor(this.random() * ns11.length);
		if (rnd10 === 1) {
			while (rnd11 > 9) {
				rnd11 = Math.floor(this.random() * ns11.length);
			}
		}
		var rnd12 = Math.floor(this.random() * ns12.length);
		var rnd13 = Math.floor(this.random() * ns13.length);
		var rnd14 = Math.floor(this.random() * ns14.length);
		var rnd15 = Math.floor(this.random() * ns15.length);
		var rnd16 = Math.floor(this.random() * ns16.length);
		var rnd17 = Math.floor(this.random() * ns17.length);
		var rnd18 = Math.floor(this.random() * ns18.length);
		var rnd19 = Math.floor(this.random() * ns19.length);
		var rnd20 = Math.floor(this.random() * ns20.length);
		var rnd21a = Math.floor(this.random() * ns21.length);
		var rnd21b = Math.floor(this.random() * ns21.length);
		while (rnd21a === rnd21b) {
			rnd21b = Math.floor(this.random() * ns21.length);
		}
