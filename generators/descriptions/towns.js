...
module.exports = generatorOf(function generator$descriptions$towns() {
	...
	var random12 = parseInt(Math.floor((this.random() * names11.length)));
	while (random12 == random11) {
		random12 = parseInt(Math.floor((this.random() * names11.length)));
	}
	var random13 = parseInt(Math.floor((this.random() * names11.length)));
	while (random13 == random12 || random13 == random11) {
		random13 = parseInt(Math.floor((this.random() * names11.length)));
	}
	var random14 = parseInt(Math.floor((this.random() * names14.length)));
	var random15 = parseInt(Math.floor((this.random() * names14.length)));
	while (random15 == random14) {
		random15 = parseInt(Math.floor((this.random() * names14.length)));
	}

	var random16 = parseInt(Math.floor((this.random() * names11.length)));
	while (random16 == random11 || random16 == random12 || random16 == random13) {
		random16 = parseInt(Math.floor((this.random() * names11.length)));
	}
	...
	var random38 = parseInt(Math.floor((this.random() * names38.length)));

	var random39 = parseInt(Math.floor((this.random() * 50 + 20)));
	var random40 = random39.toString();

	var random41 = parseInt(Math.floor((this.random() * names41.length)));
	...
	if (random6 == 2) {
		...
		random5 = parseInt(Math.floor((this.random() * names5.length)));
		random8 = parseInt(Math.floor((this.random() * names8.length)));
	} else if (random6 == 3) {
		...
		random5 = parseInt(Math.floor((this.random() * names5.length)));
		random7 = parseInt(Math.floor((this.random() * names7.length)));
		random8 = parseInt(Math.floor((this.random() * names8.length)));
	} else if (random6 == 5) {
	...
	var random7 = parseInt(Math.floor((this.random() * names7.length)));
