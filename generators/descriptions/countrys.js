...
module.exports = generatorOf(function generator$descriptions$countrys() {
	...
	var names3 = parseInt(Math.floor((this.random() * 15000000 + 1000000)));
	...
	var random1 = parseInt(Math.floor((this.random() * names1.length)));
	var random2 = parseInt(Math.floor((this.random() * names2.length)));
	if (random2 > 4) {
		names3 = parseInt(Math.floor((this.random() * 1200000 + 100000)));
	} else if (random2 == 10) {
		names3 = parseInt(Math.floor((this.random() * 5000000 + 500000)));
	}
	var random4 = parseInt(Math.floor((this.random() * names4.length)));
	var random5 = parseInt(Math.floor((this.random() * names5.length)));
	var random6 = parseInt(Math.floor((this.random() * names5.length)));
	var random7 = parseInt(Math.floor((this.random() * names5.length)));
	var random8 = parseInt(Math.floor((this.random() * names5.length)));
	var random9 = parseInt(Math.floor((this.random() * names6.length)));
	var random10 = parseInt(Math.floor((this.random() * names6.length)));
	while (random9 == random10) {
		random10 = parseInt(Math.floor((this.random() * names6.length)));
	}
	var random11 = parseInt(Math.floor((this.random() * names6.length)));
	while (random11 == random10 || random11 == random9) {
		random11 = parseInt(Math.floor((this.random() * names6.length)));
	}
	var random12 = parseInt(Math.floor((this.random() * names7.length)));
	if (random12 < 3) {
	...
	var random3 = parseInt(Math.floor((this.random() * names7b.length)));
	var random13 = parseInt(Math.floor((this.random() * names8.length)));
	if (random13 < 8) {
	...
	var random15 = parseInt(Math.floor((this.random() * names10.length)));
	var random17 = parseInt(Math.floor((this.random() * names12.length)));
	if (random17 > 16) {
	...
	var random18 = parseInt(Math.floor((this.random() * names13.length)));
	var random19 = parseInt(Math.floor((this.random() * names13.length)));
	var random20 = parseInt(Math.floor((this.random() * names13.length)));
	var random21 = parseInt(Math.floor((this.random() * names14.length)));
	var random22 = parseInt(Math.floor((this.random() * names15.length)));
	var random23 = parseInt(Math.floor((this.random() * names16.length)));
	if (random23 > 19) {
	...
	var random25 = parseInt(Math.floor((this.random() * names18.length)));
	var random26 = parseInt(Math.floor((this.random() * names19.length)));
	var random27 = parseInt(Math.floor((this.random() * names20.length)));
	if (random23 > 9) {
	...
	var random28 = parseInt(Math.floor((this.random() * names21.length)));
	var random29 = parseInt(Math.floor((this.random() * names22.length)));
	var random30 = parseInt(Math.floor((this.random() * names23.length)));
	var random31 = parseInt(Math.floor((this.random() * names24.length)));
	var random32 = parseInt(Math.floor((this.random() * names25.length)));
	var random33 = parseInt(Math.floor((this.random() * names26.length)));
	var random33b = parseInt(Math.floor((this.random() * names26b.length)));
	while (random33b == random33) {
		random33b = parseInt(Math.floor((this.random() * names26b.length)));
	}
	var random33c = parseInt(Math.floor((this.random() * names26b.length)));
	while (random33b == random33c || random33 == random33c) {
		random33c = parseInt(Math.floor((this.random() * names26b.length)));
	}
	var random33d = parseInt(Math.floor((this.random() * names26b.length)));
	while (random33d == random33 || random33d == random33b || random33d == random33c) {
		random33d = parseInt(Math.floor((this.random() * names26b.length)));
	}
	var random33e = parseInt(Math.floor((this.random() * names26c.length)));
	while (random33e == random33 || random33e == random33b || random33e == random33c || random33e == random33d) {
		random33e = parseInt(Math.floor((this.random() * names26c.length)));
	}
	var random34 = parseInt(Math.floor((this.random() * names27.length)));
	var random35 = parseInt(Math.floor((this.random() * names28.length)));
