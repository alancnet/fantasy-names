...
module.exports = generatorOf(function generator$descriptions$wands() {
	...
	var rnd1a = Math.floor(this.random() * nm1.length);
	var rnd1b = Math.floor(this.random() * nm1.length);
	while (rnd1a === rnd1b) {
		rnd1b = Math.floor(this.random() * nm1.length);
	}
	...
	var rnd10a = Math.floor(this.random() * nm10.length);
	if (rnd10a < 4) {
		if (rnd10 < 4) {
			nm12a = " and ";
