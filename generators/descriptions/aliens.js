...
module.exports = generatorOf(function generator$descriptions$aliens() {
	...
	var random2a = parseInt(Math.floor((this.random() * names2a.length)));
	var random2b = parseInt(Math.floor((this.random() * names2b.length)));
	var random2c = parseInt(Math.floor((this.random() * names2c.length)));
	var random3 = parseInt(Math.floor((this.random() * names3.length)));
	var random4 = parseInt(Math.floor((this.random() * names4.length)));
	var random5a = parseInt(Math.floor((this.random() * names5.length)));
	var random5b = parseInt(Math.floor((this.random() * names5.length)));
	while (random5b === random5a) {
		random5b = parseInt(Math.floor((this.random() * names5.length)));
	}
	var random6a = parseInt(Math.floor((this.random() * names6.length)));
	var random6b = parseInt(Math.floor((this.random() * names6.length)));
	while (random6b === random6a) {
		random6b = parseInt(Math.floor((this.random() * names6.length)));
	}
	...
	var random12a = parseInt(Math.floor((this.random() * names12a.length)));
	var random12b = parseInt(Math.floor((this.random() * names12b.length)));
	while (random12b === random12a) {
		random2b = parseInt(Math.floor((this.random() * names12b.length)));
	}
	var random12c = parseInt(Math.floor((this.random() * names12c.length)));
	while (random12c === random12a || random12c === random12b) {
		random12c = parseInt(Math.floor((this.random() * names12c.length)));
	}
	var random12d = parseInt(Math.floor((this.random() * names12c.length)));
	while (random12d === random12a || random12d === random12b || random12d === random12c) {
		random12d = parseInt(Math.floor((this.random() * names12c.length)));
	}
	var random12e = parseInt(Math.floor((this.random() * names12d.length)));
	while (random12e === random12a || random12e === random12b || random12e === random12c || random12e === random12d) {
		random12e = parseInt(Math.floor((this.random() * names12d.length)));
	}
	var random13 = parseInt(Math.floor((this.random() * names13.length)));
	var random14a = parseInt(Math.floor((this.random() * names14.length)));
	var random14b = parseInt(Math.floor((this.random() * names14.length)));
	while (random14b === random14a) {
		random14b = parseInt(Math.floor((this.random() * names14.length)));
	}
