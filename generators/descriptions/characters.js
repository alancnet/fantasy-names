...
module.exports = generatorOf(function generator$descriptions$characters(type) {
	if (typeof type !== 'object') {
		type = {
			gender: type === 1 ? 'female' : 'male'
		}
	} else {
		type = Object.assign({}, type)
	}
	if (type.race && !type.racePlural) type.racePlural = pluralize(type.race)
	
	return type.gender === 'female' ? generator$descriptions$charactersFemale.call(this, type) : generator$descriptions$charactersMale.call(this, type);
})

function generator$descriptions$charactersMale(type) {
		var hairColors = ["Black", "Gray", "White", "Blonde", "Brown", "Red", "Ginger", "Chestnut", "Silver"];
		var hairTypes = ["short hair", "short spiky hair", "short bristly hair", "well groomed hair", "crinkly hair", "sleek hair", "flowing hair", "shaggy hair", "well groomed hair", "long hair", "curly hair", "straight hair", "wavy hair", "frizzy hair", "coily hair", "long hair", "curly hair", "straight hair", "wavy hair", "frizzy hair", "coily hair", "dreadlocks", "shoulder-length hair"];
		var hairBehaviors = ["hangs over", "slightly reveals", "tight in a ponytail reveals", "gently hangs over", "slightly covers", "almost fully covers", "clumsily hangs over", "awkwardly hangs over", "neatly coiffured to reveal", "is pulled back to reveal"];
		var faceShapes = ["thin", "chiseled", "craggy", "fine", "fresh", "full", "furrowed", "handsome", "sculpted", "weak", "strong", "long", "round", "bony", "lean", "skinny", "fat"];
		var facePersonalities = ["time-worn", "cheerful", "friendly", "charming", "radiant", "warm", "anguished", "menacing", "lively", "tense", "wild", "gloomy", "frowning", "worried", "sad", "lived-in"];

		var eyeAppearances = ["Beady", "Big, round", "Bloodshot", "Bright", "Bulging", "Clear", "Dancing", "Darting", "Dead", "Expressive", "Gentle", "Glinting", "Glistening", "Glittering", "Heavy", "Hollow", "Hooded", "Lidded", "Narrow", "Piercing", "Round", "Shining", "Shuttered", "Small", "Smart", "Sparkling", "Squinting", "Wide", "Woeful"];
		var eyeColors = ["blue", "brown", "hazel", "black", "green", "amber", "gray"];
		var eyeSocketTypes = ["deep", "narrowly", "buried", "far", "rooted", "well", "low", "high", "sunken", "lightly", "thightly", "graciously", "concealed", "delicately", "elegantly", "handsomely", "a-symmetrically", "gracefully", "seductively", "appealingly", "charmingly", "dreadfully", "wickedly"];
		...
		var random21 = parseInt(Math.floor((this.random() * names21.length)));
		if (random21 > 3 && random21 < 9) {
			hairColors = ["Purple", "Blue", "Green", "Red", "White", "Blonde", "Brown", "Light blue", "Light green", "Pink", "Silver", "Golden"];
			hairTypes = ["perfectly groomed hair", "well groomed hair", "sleek hair", "long hair", "curly hair", "straight hair", "flowing hair", "wavy hair", "shoulder-length hair"];
			faceShapes = ["thin", "chiseled", "craggy", "fine", "fresh", "full", "furrowed", "handsome", "sculpted", "strong", "long", "round", "bony", "lean"];
			eyeColors = ["blue", "brown", "hazel", "green", "amber", "gray", "sapphire", "aquamarine", "pink", "red", "golden", "violet", "silver"];
			...
			hairColors = ["Purple", "Blue", "Green", "Red", "White", "Brown", "Light blue", "Light green", "Orange", "Silver", "Golden", "Yellow", "Black", "Blue", "Brown", "Hazel", "Black", "Green", "Amber", "Gray"];
			hairTypes = ["short hair", "short hair", "short hair", "long hair", "curly hair", "straight hair", "sleek hair", "frizzy hair", "shaggy hair", "shoulder-length hair"];
			faceShapes = ["thin", "fine", "fresh", "full", "handsome", "round", "bony", "lean", "skinny", "fat"];
			...
			hairTypes = ["short hair", "short hair", "short hair", "long hair", "curly hair", "straight hair", "coily hair", "shaggy hair", "greasy hair", "oily hair", "frizzy hair", "shoulder-length hair", "dreadlocks"];
			faceShapes = ["thin", "chiseled", "craggy", "fine", "fresh", "full", "furrowed", "strong", "long", "round", "bony", "lean", "skinny"];
			...
			hairTypes = ["short hair", "short hair", "short hair", "long hair", "curly hair", "coily hair", "greasy hair", "shaggy hair", "oily hair", "frizzy hair", "shoulder-length hair"];
			faceShapes = ["craggy", "fine", "fresh", "full", "furrowed", "strong", "long", "round", "fat"];
			if (random21 == 14) {
		...
		var random1 = parseInt(Math.floor((this.random() * hairColors.length)));
		var random2 = parseInt(Math.floor((this.random() * hairTypes.length)));
		var random3 = parseInt(Math.floor((this.random() * hairBehaviors.length)));
		var random4 = parseInt(Math.floor((this.random() * faceShapes.length)));
		var random5 = parseInt(Math.floor((this.random() * facePersonalities.length)));
		var random6 = parseInt(Math.floor((this.random() * eyeAppearances.length)));
		var random7 = parseInt(Math.floor((this.random() * eyeColors.length)));
		var random8 = parseInt(Math.floor((this.random() * eyeSocketTypes.length)));
		var random9 = parseInt(Math.floor((this.random() * names9.length)));
		var random10 = parseInt(Math.floor((this.random() * names10.length)));
		var random11 = parseInt(Math.floor((this.random() * names11.length)));
		var random12 = parseInt(Math.floor((this.random() * names12.length)));
		...
		var random13 = parseInt(Math.floor((this.random() * names13.length)));
		var random14 = parseInt(Math.floor((this.random() * names14.length)));
		var random15 = parseInt(Math.floor((this.random() * names15.length)));
		var random16 = parseInt(Math.floor((this.random() * names16.length)));
		var random17 = parseInt(Math.floor((this.random() * names17.length)));
		var random18 = parseInt(Math.floor((this.random() * names18.length)));
		var random19 = parseInt(Math.floor((this.random() * names19.length)));
		var random20 = parseInt(Math.floor((this.random() * names20.length)));
		var random22 = parseInt(Math.floor((this.random() * names22.length)));
		var random23 = parseInt(Math.floor((this.random() * names23.length)));
		var random24 = parseInt(Math.floor((this.random() * names24.length)));
		var random25 = parseInt(Math.floor((this.random() * names25.length)));
		var random26 = parseInt(Math.floor((this.random() * names26.length)));
		while (random26 == random25) {
			random26 = parseInt(Math.floor((this.random() * names26.length)));
		}
		var random27 = parseInt(Math.floor((this.random() * names27.length)));
		var random28 = parseInt(Math.floor((this.random() * names28.length)));

		var name = hairColors[random1] + ", " + hairTypes[random2] + " " + hairBehaviors[random3] + " a " + faceShapes[random4] + ", " + facePersonalities[random5] + " face. " + eyeAppearances[random6] + " " + eyeColors[random7] + " eyes, set " + eyeSocketTypes[random8] + " within their sockets, watch " + names9[random9] + " over the " + names10[random10] + " they've " + names11[random11] + " for so long.";
		...
		var name3 = "The is the face of " + (type.name || (names18[random18] + " " + names19[random19])) + ", a true " + names20[random20] + " among " + (type.racePlural || names21[random21]) + ". He stands " + names22[random22] + " others, despite his " + names23[random23] + " frame.";
...
function generator$descriptions$charactersFemale(type) {
	var hairColors = ["Black", "Gray", "White", "Blonde", "Brown", "Red", "Ginger", "Chestnut", "Silver"];
	var hairTypes = ["short hair", "short curly hair", "short layered hair", "well groomed hair", "crinkly hair", "sleek hair", "flowing hair", "shaggy hair", "well groomed hair", "long hair", "curly hair", "straight hair", "wavy hair", "frizzy hair", "coily hair", "short hair", "long hair", "curly hair", "straight hair", "wavy hair", "frizzy hair", "coily hair", "dreadlocks", "hip-length hair", "shoulder-length hair"];
	var hairBehaviors = ["hangs over", "slightly reveals", "braided to reveal", "double braided to reveal", "tight in a bun reveals", "tight in a ponytail reveals", "gently hangs over", "slightly covers", "almost fully covers", "clumsily hangs over", "awkwardly hangs over", "neatly coiffured to reveal", "is pulled back to reveal"];
	var faceShapes = ["thin", "chiseled", "craggy", "fine", "fresh", "full", "furrowed", "handsome", "sculpted", "weak", "strong", "long", "round", "bony", "lean", "skinny", "fat"];
	var facePersonalities = ["time-worn", "cheerful", "friendly", "charming", "radiant", "warm", "anguished", "menacing", "lively", "tense", "wild", "gloomy", "frowning", "worried", "sad", "lived-in"];
	...
	if (random21 > 3 && random21 < 10) {
		hairColors = ["Purple", "Blue", "Green", "Red", "White", "Blonde", "Brown", "Light blue", "Light green", "Pink", "Silver", "Golden"];
		hairTypes = ["perfectly groomed hair", "well groomed hair", "long wavy hair", "long layed hair", "layered hair", "sleek hair", "long hair", "curly hair", "straight hair", "flowing hair", "wavy hair", "shoulder-length hair"];
		faceShapes = ["thin", "chiseled", "craggy", "fine", "fresh", "full", "furrowed", "handsome", "sculpted", "strong", "long", "round", "bony", "lean"];
		eyeColors = ["blue", "brown", "hazel", "green", "amber", "gray", "sapphire", "aquamarine", "pink", "red", "golden", "violet", "silver"];
		names10 = ["village", "lands", "people", "town", "families", "ships", "armies", "homes", "castle", "palace", "natives", "wildlife", "farms", "country", "haven", "mountains", "rivers", "river", "sea", "woods", "woodlands", "ancestors", "children", "spirits"];
	...
	var name3 = "The is the face of " + (type.name || (names18[random18] + " " + names19[random19])) + ", a true " + names20[random20] + " among " + (type.racePlural || names21[random21]) + ". She stands " + names22[random22] + " others, despite her " + names23[random23] + " frame.";
