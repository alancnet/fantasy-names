...
module.exports = generatorOf(function generator$descriptions$citys() {﻿
	...
	var rnd8c = Math.floor(this.random() * nm8c.length);
	...
	var rnd17c = Math.floor(this.random() * nm17.length);
	while (rnd17 === rnd17c || rnd17b === rnd17c) {
		rnd17c = Math.floor(this.random() * nm17.length);
	}
	...
	while (rnd18 === rnd18b) {
		rnd18b = Math.floor(this.random() * nm18.length);
	}
	var rnd18c = Math.floor(this.random() * nm18.length);
	while (rnd17 === rnd18c || rnd18b === rnd18c) {
		rnd18c = Math.floor(this.random() * nm18.length);
	}
