...
module.exports = generatorOf(function generator$descriptions$medieval_clothings(type) {
	...
	if (tp === 1) {
		var rnd = Math.floor(this.random() * nm1.length);
		...
		while (rnd === rnd1) {
			rnd1 = Math.floor(this.random() * nm1.length);
		}
		...
		var rnd16b = Math.floor(this.random() * nm6.length);
		...
		var rnd34 = Math.floor(this.random() * nm25.length);
