...
module.exports = generatorOf(function generator$descriptions$gods(type) {
	...
	var rnd5b = Math.floor(this.random() * nm5.length);
	while (rnd5 === rnd5b) {
		rnd5b = Math.floor(this.random() * nm5.length);
	}
	var rnd6 = Math.floor(this.random() * nm6.length);
	var rnd8 = Math.floor(this.random() * nm8.length);
	var rnd8b = Math.floor(this.random() * nm8b.length);
	while (rnd8 === rnd8b) {
		rnd8b = Math.floor(this.random() * nm8b.length);
	}
	var rnd9 = Math.floor(this.random() * nm9.length);
	var rnd9b = Math.floor(this.random() * nm9.length);
	while (rnd9 === rnd9b) {
		rnd9b = Math.floor(this.random() * nm9.length);
	}
	var rnd10 = Math.floor(this.random() * nm10.length);
	var rnd11 = Math.floor(this.random() * nm11.length);
	while (rnd10 === rnd11) {
		rnd11 = Math.floor(this.random() * nm11.length);
	}
	...
	var rnd23b = Math.floor(this.random() * nm23.length);
	while (rnd23 === rnd23b) {
		rnd23b = Math.floor(this.random() * nm23.length);
	}
	...
	var rnd26b = Math.floor(this.random() * nm26.length);
	while (rnd26 === rnd26b) {
		rnd26b = Math.floor(this.random() * nm26.length);
	}
	var rnd27 = Math.floor(this.random() * nm27.length);
	var rnd28 = Math.floor(this.random() * nm28.length);
	if (rnd28 === 0) {
		nm29 = "lover"
		var rnd1b = Math.floor(this.random() * nm1.length);
		var rnd2b = Math.floor(this.random() * nm2.length);
		var rnd3b = Math.floor(this.random() * nm3b.length);
	...
	var rnd31 = Math.floor(this.random() * nm31.length);
	var rnd32 = Math.floor(this.random() * nm32.length);
	var rnd33 = Math.floor(this.random() * nm33.length);
