...
module.exports = generatorOf(function generator$descriptions$laws() {
	...
	var rnd4 = Math.floor(this.random() * nm1.length);
	var rnd5 = Math.floor(this.random() * nm2.length);
	var rnd6 = Math.floor(this.random() * nm3.length);
	var rnd7 = Math.floor(this.random() * nm1.length);
	var rnd8 = Math.floor(this.random() * nm2.length);
	var rnd9 = Math.floor(this.random() * nm3.length);
	...
	var rnd13 = Math.floor(this.random() * nm1.length);
	var rnd14 = Math.floor(this.random() * nm2.length);
	var rnd15 = Math.floor(this.random() * nm3.length);
