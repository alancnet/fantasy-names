...
module.exports = generatorOf(function generator$descriptions$dragons() {
	...
	var rnd4a = Math.floor(this.random() * nm4.length);
	var rnd4b = Math.floor(this.random() * nm4.length);
	if (rnd4a < 8) {
		while (rnd4b > 7) {
			rnd4b = Math.floor(this.random() * nm4.length);
			while (rnd4a === rnd4b) {
				rnd4b = Math.floor(this.random() * nm4.length);
			}
		}
	...
	var rnd7b = Math.floor(this.random() * nm7.length);
	...
	while (rnd17 === rnd17a) {
		rnd17a = Math.floor(this.random() * nm17.length);
	}
	...
	var rnd22a = Math.floor(this.random() * nm22.length);
	...
	var rnd30 = Math.floor(this.random() * nm30.length);
