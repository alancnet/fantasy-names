...
module.exports = generatorOf(function generator$descriptions$personalitys(type) {
	...
	var tp = type;
	var rnd13b = Math.floor(this.random() * nm23.length);
	if (rnd13b > 99) {
		nm25 = ["she's", "her", "Her", "She's"];
	}
	var rnd14b = Math.floor(this.random() * nm24.length);
	if (tp === 1) {
		var rnd1 = Math.floor(this.random() * nm11.length);
		var rnd2 = Math.floor(this.random() * nm12.length);
		var rnd3 = Math.floor(this.random() * nm13.length);
		var rnd4 = Math.floor(this.random() * nm14.length);
		var rnd5 = Math.floor(this.random() * nm15.length);
		var rnd6 = Math.floor(this.random() * nm16.length);
		var rnd7 = Math.floor(this.random() * nm17.length);
		var rnd8 = Math.floor(this.random() * nm18.length);
		var rnd9 = Math.floor(this.random() * nm19.length);
		var rnd10 = Math.floor(this.random() * nm20.length);
		var rnd11 = Math.floor(this.random() * nm22.length);
		var rnd12 = Math.floor(this.random() * nm22.length);
		var rnd13 = Math.floor(this.random() * nm22.length);
		var rnd14 = Math.floor(this.random() * nm22.length);
		var rnd15 = Math.floor(this.random() * nm22.length);
		var rnd16 = Math.floor(this.random() * nm21.length);
		var rnd17 = Math.floor(this.random() * nm22.length);
		var rnd18 = Math.floor(this.random() * nm21.length);
		var rnd19 = Math.floor(this.random() * nm21.length);
		...
		var rnd11 = Math.floor(this.random() * nm21.length);
		var rnd12 = Math.floor(this.random() * nm21.length);
		var rnd13 = Math.floor(this.random() * nm21.length);
		var rnd14 = Math.floor(this.random() * nm21.length);
		var rnd15 = Math.floor(this.random() * nm21.length);
		var rnd16 = Math.floor(this.random() * nm22.length);
		var rnd17 = Math.floor(this.random() * nm21.length);
		var rnd18 = Math.floor(this.random() * nm22.length);
		var rnd19 = Math.floor(this.random() * nm22.length);
