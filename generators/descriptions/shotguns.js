...
module.exports = generatorOf(function generator$descriptions$shotguns() {
	...
	var nm6 = Math.floor((this.random() * 500) + 600);
	var nm7 = nm6 - Math.floor((this.random() * 200) + 100);
	var nm8 = Math.floor((this.random() * 27) + 21) / 10;
	...
	var rnd11a = Math.floor(this.random() * nm11.length);
	var rnd11b = Math.floor(this.random() * nm11.length);
	while (rnd11a === rnd11b) {
		rnd11b = Math.floor(this.random() * nm11.length);
	}
	var rnd11c = Math.floor(this.random() * nm11.length);
	while (rnd11a === rnd11c || rnd11b === rnd11c) {
		rnd11c = Math.floor(this.random() * nm11.length);
	}
	var rnd11d = Math.floor(this.random() * nm11.length);
	while (rnd11a === rnd11d || rnd11b === rnd11d || rnd11c === rnd11d) {
		rnd11d = Math.floor(this.random() * nm11.length);
	}

	var rnd12a = Math.floor(this.random() * nm12.length);
	var rnd12b = Math.floor(this.random() * nm12.length);
	while (rnd12a === rnd12b) {
		rnd12b = Math.floor(this.random() * nm12.length);
	}
	var rnd12c = Math.floor(this.random() * nm12.length);
	while (rnd12a === rnd12c || rnd12b === rnd12c) {
		rnd12c = Math.floor(this.random() * nm12.length);
	}
	var rnd13a = Math.floor(this.random() * nm13.length);
	var rnd13b = Math.floor(this.random() * nm13.length);
	while (rnd13a === rnd13b) {
		rnd13b = Math.floor(this.random() * nm13.length);
	}
	var rnd13c = Math.floor(this.random() * nm13.length);
	while (rnd13a === rnd13c || rnd13b === rnd13c) {
		rnd13c = Math.floor(this.random() * nm13.length);
	}
	var rnd14a = Math.floor(this.random() * nm14.length);
	var rnd14b = Math.floor(this.random() * nm14.length);
	while (rnd14a === rnd14b) {
		rnd14b = Math.floor(this.random() * nm14.length);
	}
	var rnd14c = Math.floor(this.random() * nm14.length);
	while (rnd14a === rnd14c || rnd14b === rnd14c) {
		rnd14c = Math.floor(this.random() * nm14.length);
	}

	var rnd15 = Math.floor(this.random() * nm15.length);
	var rnd16 = Math.floor(this.random() * nm16.length);
	var rnd16a = Math.floor(this.random() * nm16.length);
	var rnd16b = Math.floor(this.random() * nm16.length);
	while (rnd16a === rnd16b) {
		rnd16b = Math.floor(this.random() * nm16.length);
	}
	var rnd16c = Math.floor(this.random() * nm16.length);
	while (rnd16a === rnd16c || rnd16b === rnd16c) {
		rnd16c = Math.floor(this.random() * nm16.length);
	}
	var rnd17a = Math.floor(this.random() * nm17.length);
	var rnd17b = Math.floor(this.random() * nm17.length);
	var rnd18a = Math.floor(this.random() * nm18.length);
	var rnd18b = Math.floor(this.random() * nm18.length);
	var rnd18c = Math.floor(this.random() * nm18.length);
	var rnd18d = Math.floor(this.random() * nm18.length);
	var rnd19 = Math.floor(this.random() * nm19.length);
