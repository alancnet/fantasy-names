...
module.exports = generatorOf(function generator$descriptions$dungeons() {
	...
	var rnd6a = Math.floor(this.random() * nm6.length);
	var rnd6b = Math.floor(this.random() * nm6.length);
