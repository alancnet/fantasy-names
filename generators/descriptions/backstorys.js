...
module.exports = generatorOf(function generator$descriptions$backstorys(type) {
	...
	var nm9 = Math.floor(this.random() * 10) + 10;
	...
	if (tp === 2) {
		...
		nm9 = Math.floor(this.random() * 13) + 4;
	...
	var rnd12b = Math.floor(this.random() * nm12b.length);
	var rnd13 = Math.floor(this.random() * nm13.length);
	var rnd14 = Math.floor(this.random() * nm14.length);
	var rnd15a = Math.floor(this.random() * nm15.length);
	var rnd15b = Math.floor(this.random() * nm15.length);
	while (rnd15a === rnd15b) {
		rnd15b = Math.floor(this.random() * nm15.length);
	}
	var rnd16 = Math.floor(this.random() * nm16.length);
	var rnd17 = Math.floor(this.random() * nm17.length);
	while (rnd16 === rnd17) {
		rnd17 = Math.floor(this.random() * nm17.length);
	}
