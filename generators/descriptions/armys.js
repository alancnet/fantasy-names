...
module.exports = generatorOf(function generator$descriptions$armys() {
	...
	var rnd14d = Math.floor(this.random() * nm14.length);
	while (rnd14d === rnd14a || rnd14d === rnd14b || rnd14d === rnd14c) {
		rnd14d = Math.floor(this.random() * nm14.length);
	}
