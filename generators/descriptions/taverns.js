...
module.exports = generatorOf(function generator$descriptions$taverns() {
	var type = this.random();
	...
	var random1a = parseInt(Math.floor((this.random() * names1.length)));
	var random1b = parseInt(Math.floor((this.random() * names1.length)));
	while (random1a === random1b) {
		random1b = parseInt(Math.floor((this.random() * names1.length)));
	}
	var random1c = parseInt(Math.floor((this.random() * names1.length)));
	while (random1a === random1c || random1b === random1c) {
		random1c = parseInt(Math.floor((this.random() * names1.length)));
	}
	...
	var random8a = parseInt(Math.floor((this.random() * names8.length)));
	var random8b = parseInt(Math.floor((this.random() * names8.length)));
	while (random8a === random8b) {
		random8b = parseInt(Math.floor((this.random() * names8.length)));
	}
