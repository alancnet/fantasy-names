...
module.exports = generatorOf(function generator$descriptions$societys() {
	...
	var random3a = parseInt(Math.floor((this.random() * names3.length)));
	var random3b = parseInt(Math.floor((this.random() * names3.length)));
	while (random3b === random3a) {
		random3b = parseInt(Math.floor((this.random() * names3.length)));
	}
	var random3c = parseInt(Math.floor((this.random() * names3.length)));
	while (random3c === random3a || random3c === random3b) {
		random3c = parseInt(Math.floor((this.random() * names3.length)));
	}
	...
	var random5c = parseInt(Math.floor((this.random() * names5.length)));
	while (random5c === random5a || random5c === random5b) {
		random5c = parseInt(Math.floor((this.random() * names5.length)));
	}
	var random5d = parseInt(Math.floor((this.random() * names5.length)));
	while (random5d === random5a || random5d === random5b || random5d === random5c) {
		random5d = parseInt(Math.floor((this.random() * names5.length)));
	}
	var random5e = parseInt(Math.floor((this.random() * names5.length)));
	while (random5e === random5a || random5e === random5b || random5e === random5c || random5e === random5d) {
		random5e = parseInt(Math.floor((this.random() * names5.length)));
	}
	...
	var random23a = parseInt(Math.floor((this.random() * names23.length)));
	var random23b = parseInt(Math.floor((this.random() * names23.length)));
	while (random23a === random23b) {
		random23b = parseInt(Math.floor((this.random() * names23.length)));
	}
