...
module.exports = generatorOf(function generator$descriptions$traditions() {
	...
	var rnd6b = Math.floor(this.random() * nm6[rnd6][0].length);
	var rnd6c = Math.floor(this.random() * nm6[rnd6][1].length);
	var rnd6d = Math.floor(this.random() * nm6[rnd6][1].length);
	while (rnd6c === rnd6d) {
		var rnd6d = Math.floor(this.random() * nm6[rnd6][1].length);
	}
	var rnd7 = Math.floor(this.random() * nm7.length);
	var rnd8 = Math.floor(this.random() * nm8.length);
	var rnd9 = Math.floor(this.random() * nm9.length);

	var rnd10 = Math.floor(this.random() * nm1.length);
	var rnd11 = Math.floor(this.random() * nm2.length);
	var rnd12 = Math.floor(this.random() * nm3.length);
	var rnd13 = Math.floor(this.random() * nm4.length);
	var rnd14 = Math.floor(this.random() * nm5.length);
	var rnd15 = Math.floor(this.random() * nm10.length);
	var rnd15b = Math.floor(this.random() * nm10[rnd15][0].length);
	var rnd15c = Math.floor(this.random() * nm10[rnd15][1].length);
