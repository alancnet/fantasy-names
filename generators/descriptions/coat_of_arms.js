...
module.exports = generatorOf(function generator$descriptions$coat_of_arms() {
	...
	if (rnd22 === 0) {
		rnd19b = Math.floor(this.random() * nm19.length);
		rnd20b = Math.floor(this.random() * nm20.length);
		if (rnd19 < 2) {
			if (rnd19b < 2) {
