...
module.exports = generatorOf(function generator$descriptions$animals() {
	...
	var random0 = parseInt(Math.floor((this.random() * names0.length)));
	...
	var random3 = parseInt(Math.floor((this.random() * names3.length)));
	var random4a = parseInt(Math.floor((this.random() * names4a.length)));
	var random4b = parseInt(Math.floor((this.random() * names4b.length)));
	var random4c = parseInt(Math.floor((this.random() * names4c.length)));
	var random5 = parseInt(Math.floor((this.random() * names5.length)));
	var random6 = parseInt(Math.floor((this.random() * names6.length)));
	var random7a = parseInt(Math.floor((this.random() * names7a.length)));
	var random7b = parseInt(Math.floor((this.random() * names7b.length)));
	while (random7b === random7a) {
		random2b = parseInt(Math.floor((this.random() * names7b.length)));
	}
	var random7c = parseInt(Math.floor((this.random() * names7c.length)));
	while (random7c === random7a || random7c === random7b) {
		random7c = parseInt(Math.floor((this.random() * names7c.length)));
	}
	var random7d = parseInt(Math.floor((this.random() * names7c.length)));
	while (random7d === random7a || random7d === random7b || random7d === random7c) {
		random7d = parseInt(Math.floor((this.random() * names7c.length)));
	}
	var random7e = parseInt(Math.floor((this.random() * names7d.length)));
	while (random7e === random7a || random7e === random7b || random7e === random7c || random7e === random7d) {
		random7e = parseInt(Math.floor((this.random() * names7d.length)));
	}
	var random8 = parseInt(Math.floor((this.random() * names8.length)));
	...
	var random15a = parseInt(Math.floor((this.random() * names15.length)));
	var random15b = parseInt(Math.floor((this.random() * names15.length)));
	while (random15b === random15a) {
		random15b = parseInt(Math.floor((this.random() * names15.length)));
	}
	...
	var random21a = parseInt(Math.floor((this.random() * names21.length)));
	var random21b = parseInt(Math.floor((this.random() * names21.length)));
	while (random21b === random21a) {
		random21b = parseInt(Math.floor((this.random() * names21.length)));
	}
