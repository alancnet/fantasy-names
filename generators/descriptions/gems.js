...
module.exports = generatorOf(function generator$descriptions$gems() {
	...
	var rnd9 = Math.floor(this.random() * nm1.length);
	var rnd10 = Math.floor(this.random() * nm2.length);
	var rnd11 = Math.floor(this.random() * nm3.length);
	var rnd12 = Math.floor(this.random() * nm4.length);
	var rnd13 = Math.floor(this.random() * nm5.length);
	var rnd14 = Math.floor(this.random() * nm6.length);
	var rnd15 = Math.floor(this.random() * nm7.length);
	var rnd16 = Math.floor(this.random() * nm8.length);
