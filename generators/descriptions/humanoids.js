...
module.exports = generatorOf(function generator$descriptions$humanoids(type) {
	...
	if (tp === 1) {
		...
		var rnd34 = Math.floor(this.random() * nm34.length);
		var rnd35 = Math.floor(this.random() * nm35.length);
		var rnd36 = Math.floor(this.random() * nm36.length);
		var rnd37 = Math.floor(this.random() * nm37.length);
		var rnd38 = Math.floor(this.random() * nm38.length);
		var rnd39 = Math.floor(this.random() * nm39.length);
		var rnd40 = Math.floor(this.random() * nm40.length);
		var rnd41 = Math.floor(this.random() * nm41.length);
		var rnd42 = Math.floor(this.random() * nm42.length);
		var rnd43 = Math.floor(this.random() * nm43.length);
		var rnd44 = Math.floor(this.random() * nm44.length);
		var rnd45 = Math.floor(this.random() * nm45.length);
		var rnd16 = Math.floor(this.random() * nm16.length);
		var rnd17 = Math.floor(this.random() * nm17.length);
		var rnd18 = Math.floor(this.random() * nm18.length);
		var rnd49 = Math.floor(this.random() * nm49.length);
		var rnd50 = Math.floor(this.random() * nm50.length);
		var rnd20 = Math.floor(this.random() * nm20.length);
		var rnd51 = Math.floor(this.random() * nm51.length);
		var rnd52 = Math.floor(this.random() * nm52.length);
		var rnd53 = Math.floor(this.random() * nm53.length);
		var rnd54 = Math.floor(this.random() * nm54.length);
		var rnd24 = Math.floor(this.random() * nm24.length);
		var rnd25 = Math.floor(this.random() * nm25.length);
		var rnd55 = Math.floor(this.random() * nm55.length);
		var rnd56 = Math.floor(this.random() * nm56.length);
		var rnd57 = Math.floor(this.random() * nm57.length);
		var rnd28 = Math.floor(this.random() * nm28.length);
		var rnd59 = Math.floor(this.random() * nm59.length);
		...
		var rnd20 = Math.floor(this.random() * nm20.length);
		var rnd21 = Math.floor(this.random() * nm21.length);
		var rnd22 = Math.floor(this.random() * nm22.length);
		var rnd23 = Math.floor(this.random() * nm23.length);
		var rnd24 = Math.floor(this.random() * nm24.length);
		var rnd25 = Math.floor(this.random() * nm25.length);
		var rnd26 = Math.floor(this.random() * nm26.length);
		var rnd27 = Math.floor(this.random() * nm27.length);
		var rnd28 = Math.floor(this.random() * nm28.length);
		var rnd29 = Math.floor(this.random() * nm29.length);
