...
module.exports = generatorOf(function generator$descriptions$battlefields() {
	...
	var rnd2a = Math.floor(this.random() * nm2.length);
	var rnd2b = Math.floor(this.random() * nm2.length);
	while (rnd2b === rnd2a) {
		rnd2b = Math.floor(this.random() * nm2.length);
	}
	var rnd2c = Math.floor(this.random() * nm2.length);
	while (rnd2c === rnd2a || rnd2c === rnd2b) {
		rnd2c = Math.floor(this.random() * nm2.length);
	}
	var rnd3a = Math.floor(this.random() * nm3.length);
	var rnd3b = Math.floor(this.random() * nm3.length);
	while (rnd3b === rnd3a) {
	...
	while (rnd17b === rnd17a) {
		rnd17b = Math.floor(this.random() * nm17.length);
	}
	...
	var rnd27a = Math.floor(this.random() * nm27.length);
	var rnd27b = Math.floor(this.random() * nm27.length);
	while (rnd27b === rnd27a) {
		rnd27b = Math.floor(this.random() * nm27.length);
	}
	var rnd27c = Math.floor(this.random() * nm27.length);
	while (rnd27c === rnd27a || rnd27c === rnd27b) {
		rnd27c = Math.floor(this.random() * nm27.length);
	}
	var rnd28a = Math.floor(this.random() * nm28.length);
	var rnd28b = Math.floor(this.random() * nm28.length);
	while (rnd3b === rnd3a) {
		rnd28b = Math.floor(this.random() * nm28.length);
	}
	var rnd28c = Math.floor(this.random() * nm28.length);
	while (rnd28c === rnd28a || rnd28c === rnd28b) {
		rnd28c = Math.floor(this.random() * nm28.length);
	}
