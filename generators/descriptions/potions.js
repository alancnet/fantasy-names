...
module.exports = generatorOf(function generator$descriptions$potions() {
	...
	var rnd3c = Math.floor(this.random() * nm3.length);
	var rnd3d = Math.floor(this.random() * nm3.length);
	var rnd3e = Math.floor(this.random() * nm3.length);
	...
	var rnd4c = Math.floor(this.random() * nm4.length);
	while (rnd4b === rnd4c || rnd4a === rnd4c) {
		rnd4c = Math.floor(this.random() * nm4.length);
	}
	var rnd4d = Math.floor(this.random() * nm4.length);
	while (rnd4d === rnd4a || rnd4d === rnd4b || rnd4d === rnd4c) {
		rnd4d = Math.floor(this.random() * nm4.length);
	}
	var rnd4e = Math.floor(this.random() * nm4.length);
	while (rnd4e === rnd4a || rnd4e === rnd4b || rnd4e === rnd4c || rnd4e === rnd4d) {
		rnd4e = Math.floor(this.random() * nm4.length);
	}
	var rnd5a = Math.floor(this.random() * nm5.length);
	var rnd5b = Math.floor(this.random() * nm5.length);
	while (rnd5b === rnd5a) {
		rnd5b = Math.floor(this.random() * nm5.length);
	}
	var rnd5c = Math.floor(this.random() * nm5.length);
	while (rnd5b === rnd5c || rnd5a === rnd5c) {
		rnd5c = Math.floor(this.random() * nm5.length);
	}
	var rnd5d = Math.floor(this.random() * nm5.length);
	while (rnd5d === rnd5a || rnd5d === rnd5b || rnd5d === rnd5c) {
		rnd5d = Math.floor(this.random() * nm5.length);
	}
	var rnd5e = Math.floor(this.random() * nm5.length);
	while (rnd5e === rnd5a || rnd5e === rnd5b || rnd5e === rnd5c || rnd5e === rnd5d) {
		rnd5e = Math.floor(this.random() * nm5.length);
	}
